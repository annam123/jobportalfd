              ...
              <aside className="col-md-4">
                <div className="careerfy-right">
                  <ul className="careerfy-user-section">
                    ...
                    <li><a className="careerfy-color careerfy-open-signup-tab" href="/#">Sign in</a></li>
                  </ul>
                  ...
                  <div class="careerfy-user-form careerfy-user-form-coltwo">
                    <ul>
                      ...
                      <li>
                        ...
                        <input placeholder="Enter Your Confirm Password" type="text" />
                        <i class="careerfy-icon careerfy-technology"></i>
                      </li>
          ...
          <div className="careerfy-banner-caption">
            <div className="container">
              ...
              <form className="careerfy-banner-search">
                <ul>
                  <li>
                    <input value="Job Title, Keywords, or Company" type="text" />
                  </li>
                  <li>
                    <input value="City, State or ZIP" type="text" />
                  ...
                  <li className="careerfy-banner-submit"> <input type="submit" value="" />
